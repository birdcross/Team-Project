                ...
                <div class=" border border-tertiary p-5 rounded shadow">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-dark" style="width:100px; height:40px;"
                            onclick=location.href=`/User/Info?user_id=${ sessionScope.login.user_id}`;">수정완료</button>
                    </div>
                    <hr/>
                    <div>
                        <div class="container w-50 mt-5 text ">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" value="${userList.user_tell}" >
                                </div>
                                <div class="input-group mb-3">
                                    <span
                                 ...
                                 <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" value="${userList.user_pw}" >
                                </div>
                                 <div class="input-group mb-3">
                                    <span
                                        class="input-group-text justify-content-center hs_span_size init_color hs_span">비밀번호확인</span>
                                    <input type="text" class="form-control" value="${userList.user_pw}" >
                                </div>
