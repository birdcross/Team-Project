				...
				<div>
					<ul class="nav link-dark"
						...
						<li class="nav-item" id="main"><a
							...
							href="/Company/Main">구직자정보</a></li>
						<li class="nav-item" id="recommend"><a
							class=" nav-link link-dark" href="/Company/Community?com_id=${ sessionScope.clogin.com_id}">커뮤니티</a></li>
						<li class="nav-item" id="recommend"><a
				...
				<div>
					<c:choose>
						  <c:when test="${ sessionScope.clogin == null || clogin == '' }">
						   ...
						   <c:otherwise>
						   <a class="nav-link" href="/Company/Info?com_id=${sessionScope.clogin.com_id}"> <img
